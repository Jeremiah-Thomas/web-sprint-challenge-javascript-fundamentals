...
/* The nested function can access the variable internal because the function is created in the same block of scope as the variable */
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(arr){
    return arr.reduce((total, animal) => {
